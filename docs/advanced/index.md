...
Everything here is optional. The blueprint covers the ordinary case on its own — this
section is for when you want to know exactly what FLARE is doing, or want to drive it
yourself.

{: .note }
> New to FLARE? Start with the [Quickstart]({{ site.baseurl }}/installation/) and come back
> when you need it.
